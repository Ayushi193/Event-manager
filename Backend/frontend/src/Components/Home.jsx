    ...
    return (
      ...
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in-up">
          Welcome to <span className="text-cyan-400">HackNova</span> {userData ? (<>of {userData?.data.user.college}</>) : (<></>)}
        </h1>
       ...
       {userData ? (<>
        <Button 
         ...
         className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-full text-lg animate-fade-in-up animation-delay-400"
         >
           <Link 
           to="/hackthons"
